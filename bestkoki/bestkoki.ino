...
//#define HOST "http://192.168.2.105:8008/bootstrap%20ideas/images/OTA_WITH_SERVER.ino.bin"
#define HOST "http://192.168.2.105:8008/bootstrap%20ideas/images/bestkoki2.ino.bin"
HTTPClient client;
...
void updateFirmware(uint8_t *data, size_t len){
  ...
  Update.end(true);
  Serial.printf("\nUpdate Success bestkoki1, Total Size: %u\nRebooting...\n", currentLength);
